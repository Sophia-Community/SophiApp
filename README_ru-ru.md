...
* Выключение задания диагностического характера в Планировщике заданий;
* Настройка UI и персонализации;
* Установка последней версии распространяемых пакетов `Microsoft Visual C++ 2015–2022 x64`;
* Установка последней версии `.NET Desktop Runtime 6 x86/x64`;
* Правильное и до конца удаление OneDrive, не нарушив целостность ОС;
* Удаление UWP-приложений, отображая локализированные имена пакетов;
  * Список UWP-приложений рендерится динамически, используя локальные иконки приложений.
...
* Создание задания в Планировщике заданий по очистке
