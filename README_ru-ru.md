...
<p align="center">
    ...
    •
    <a href="#дополнение">Дополнения</a>
    •
...
> **Note**: `SophiApp` полностью портативно: не имеет конфигурационных файлов (пока) и не хранит никаких данных в реестрe. Чтобы воспользоваться приложением, просто извлеките из архива папку `SophiApp` вместе с подпапкой `Bin` и файлом `SophiApp.exe.config`, затем запустите `SophiApp.exe`.
