<div align="right">
  This page also in:
  <a title="Eanglish" href="README.md"><img src="https://upload.wikimedia.org/wikipedia/commons/a/ae/Flag_of_the_United_Kingdom.svg" height="11px"/>
...
* Больше 130 твиков; ⭐
* `SophiApp` использует паттерн [MVVM](https://en.wikipedia.org/wiki/Model-view-viewmodel);
...
* Все сборки компилируются в облаки с использованием [GitHub Actions](https://github.com/Sophia-Community/SophiApp/actions)
  * Вы можете сравнить хэш-сумму архива на странице релиза с хэш-суммой в облачной консоли на шаге `Compress Files`, чтобы бы уверенным, что архив не подменился после релиза (для открытия облачных логов вы должны было залогинены в учетную запись GitHub;
...
* Поддержка темной и светлой тем;
  * Программа умеет менять тему вгновенно, когда вы меняете тему приложений Windows по умолчанию. [GIF](#instantly-changing-theme)
...
* Создать задачи `Windows Cleanup` и `Windows Cleanup Notification` в Планировщике заданийпо очистке неиспользуемых файлов и обновлений Windows;
...
## Локализированные имена UWP-пприложений
