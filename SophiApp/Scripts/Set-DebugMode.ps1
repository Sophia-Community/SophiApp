...
$MethodsContent = Get-Content -Path "SophiApp\SophiApp\ViewModels\Methods.cs"
...
Set-Content -Path "SophiApp\SophiApp\ViewModels\Methods.cs" -Value $MethodsContent -Confirm:$false -Encoding UTF8 -Force
