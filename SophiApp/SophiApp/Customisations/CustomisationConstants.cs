...
namespace SophiApp.Customisations
{
    internal static class CustomisationConstants
    {
        ...
        internal const string _329_DESKTOP_FOLDER = "Desktop";
        internal const byte _332_AUTOMATICALLY_VALUE = 3;
        internal const byte _333_DEFAULT_VALUE = 2;
        internal const string _334_SEPARATE_PROCESS = "SeparateProcess";
        internal const string _335_RESERVE_MANAGER_PATH = @"SOFTWARE\Microsoft\Windows\CurrentVersion\ReserveManager";
        internal const string _335_SHIPPED_RESERVES = "ShippedWithReserves";
        internal const string _336_TYPELIB_PATH = @"SOFTWARE\Classes\Typelib\{8cec5860-07a1-11d9-b15e-000d56bfe6ee}";
        internal const string _336_TYPELIB_WIN64_PATH = @"SOFTWARE\Classes\Typelib\{8cec5860-07a1-11d9-b15e-000d56bfe6ee}\1.0\0\win64";
        internal const string _337_DEFAULT_KEYBOARD_PATH = @".DEFAULT\Control Panel\Keyboard";
        internal const string _337_ENABLED_VALUE = "2147483650";
        internal const string _337_INITIAL_INDICATORS = "InitialKeyboardIndicators";
        internal const string _338_KEYBOARD_LAYOUT_PATH = @"SYSTEM\CurrentControlSet\Control\Keyboard Layout";
        internal const string _338_SCAN_CODE = "Scancode Map";
        internal const string _339_DISABLED_VALUE = "506";
        internal const string _339_ENABLED_VALUE = "510";
        internal const string _339_FLAGS = "Flags";
        internal const string _339_STICKY_KEYS_PATH = @"Control Panel\Accessibility\StickyKeys";
        internal const string _340_AUTOPLAY = "DisableAutoplay";
        internal const string _340_AUTOPLAY_HANDLERS_PATH = @"SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers";
        internal const string _340_DISABLE_NET_BINDING_PS = "Disable-NetAdapterBinding –Name * –ComponentID ms_tcpip6";
        internal const byte _340_DISABLED_VALUE = 1;
        internal const string _340_ENABLE_NET_BINDING_PS = "Enable-NetAdapterBinding –Name * –ComponentID ms_tcpip6";
        internal const byte _340_ENABLED_VALUE = 0;
        ...
        internal const string _341_AUTOPLAY = "Autorun";
        internal const byte _341_DISABLED_VALUE = 0;
        internal const byte _341_ENABLED_VALUE = 3;
        internal const string _341_THUMBNAIL_CACHE_PATH = @"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Explorer\VolumeCaches\Thumbnail Cache";
        internal const string _342_RESTART_APPS = "RestartApps";
        internal const string _343_FILE_PRINTER_SHARING_GROUP = "@FirewallAPI.dll,-32752";
        internal const string _343_NET_CATEGORY_PARAM = "NetworkCategory";
        internal const string _343_NETWORK_DISCOVERY_GROUP = "@FirewallAPI.dll,-28502";
        internal const string _343_PRIVATE_VALUE = "Private";
        internal const string _343_SET_PROFILE_PS = "Set-NetConnectionProfile";
        internal const string _344_ACTIVE_HOURS = "SmartActiveHoursState";
        ...
        internal const string _349_PRODUCT_NAME = "ProductName";
        internal const string _350_DOWNLOAD_URL = "https://aka.ms/vs/17/release/vc_redist.x64.exe";
        internal const string _350_VC_REDISTR_FOR_VS_2022 = "Visual C++ Redistributable for Visual Studio 2022";
        internal const string _350_VC_REDISTRX64 = "vc_redist.x64.exe";
        internal const string _350_VC_REDISTRX64_ARGS = "/install /passive /norestart";
        internal const string _350_VC_VERSION_URL = "https://raw.githubusercontent.com/aaronparker/vcredist/main/VcRedist/VisualCRedistributables.json";
...
else
{
    ...
    <QueryConfig>
        ...
        internal static byte[] _338_DISABLED_VALUE = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0, 2, 0, 0, 0, 0, 0, 58, 0, 0, 0, 0, 0 };
