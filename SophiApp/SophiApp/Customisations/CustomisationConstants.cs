...
namespace SophiApp.Customisations
{
    internal struct CustomisationConstants
    {
        ...
        internal const string _121_AUTHZ_POLICY = "RomeSdkChannelUserAuthzPolicy";
        internal const string _121_CDP_PATH = @"SOFTWARE\Microsoft\Windows\CurrentVersion\CDP";
        internal const string _122_SUB_CONTENT = "SubscribedContent-310093Enabled";
        internal const string _123_SUB_CONTENT = "SubscribedContent-338389Enabled";
        internal const string _124_SUB_CONTENT_93 = "SubscribedContent-338393Enabled";
        internal const string _124_SUB_CONTENT_94 = "SubscribedContent-353694Enabled";
        internal const string _124_SUB_CONTENT_96 = "SubscribedContent-353696Enabled";
        internal const string _125_SILENT_APP_INSTALL = "SilentInstalledAppsEnabled";
        internal const string _126_PROFILE_ENGAGE_PATH = @"SOFTWARE\Microsoft\Windows\CurrentVersion\UserProfileEngagement";
        internal const string _126_SETTING_ENABLED = "ScoobeSystemSettingEnabled";
        internal const string _127_PRIVACY_PATH = @"SOFTWARE\Microsoft\Windows\CurrentVersion\Privacy";
        internal const string _127_TAILORED_DATA = "TailoredExperiencesWithDiagnosticDataEnabled";
