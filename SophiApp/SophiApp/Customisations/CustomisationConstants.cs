...
namespace SophiApp.Customisations
{
    internal static class CustomisationConstants
    {
        ...
        internal const string _349_PACKAGE_CACHE_NAME = "Package Cache";
        internal const string _349_REDISTRX64_REGISTRY_NAME_PATTERN = "VC,redist.x64,amd64";
        ...
        internal const string _349_VC_REDISTRX64_REGISTRY_PATH = @"Installer\Dependencies";
