...
{
    internal class MsNETButtonGroup : TextedElement, IParentElements
    {
        public MsNETButtonGroup((TextedElementDto Dto, Action<TextedElement, Exception> ErrorHandler, EventHandler<TextedElement> StatusHandler, Func<bool> Customisation, UILanguage Language) parameters) : base(parameters)
        {
