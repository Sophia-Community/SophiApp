...
namespace SophiApp.Helpers
{
    internal class CustomisationsHelper
    {
        ...
        {
            var type = Type.GetType(CUSTOMISATION_OS_CLASS);                                    //TODO: GetCustomisationOs - Remove before release.
        ...
        {
            var type = Type.GetType(CUSTOMISATION_STATE_CLASS);                                 //TODO: GetCustomisationStatus - Remove before release.
            var method = type.GetMethod($"_{id}", BindingFlags.Static | BindingFlags.Public) ?? type.GetMethod("ItsMagic", BindingFlags.Static | BindingFlags.Public);
