...
SUMMARY="$(cloc --include-ext="sln,ps1,config,manifest,xaml,cs,csproj,json,settings" --exclude-list-file=.clocignore . --md | tail -1)"
...
# lines. All dumb comments like those /////////// or those // ------------ are also substracted.
