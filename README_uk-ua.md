...
* Вимкнення завдань діагностичного характеру у Планувальнику завдань;
* Налаштування UI та персоналізації;
* Встановлення останньої версії розповсюджуваних пакетів `Microsoft Visual C++ 2015–2022 x64`;
* Встановлення останньої версії `.NET Desktop Runtime 6 x86/x64`;
* Правильно і до кінця видаляє OneDrive, не порушивши цілісність ОС;
* Видалення UWP-додатків, відображаючи локалізовані імена пакетів;
...
* Створення завдання `Windows Cleanup` та `Windows Cleanup Notification` у Планувальнику завдань з очищення файлів та оновлень Windows, що не використовуються.;
...
* Створення завдання з очищення у Планувальнику завдань;
