...
{
    internal class MsCppPackageButtonGroup : TextedElement, IParentElements
    {
        public MsCppPackageButtonGroup((TextedElementDto Dto, Action<TextedElement, Exception> ErrorHandler, EventHandler<TextedElement> StatusHandler, Func<bool> Customisation, UILanguage Language) parameters) : base(parameters)
        {
